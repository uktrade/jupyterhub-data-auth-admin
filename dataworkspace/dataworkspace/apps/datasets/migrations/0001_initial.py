    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'grouping',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='datasets.DataGrouping',),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='datasets.DataGrouping',),),
                (
                    'updated_by',
                    models.ForeignKey(
                        blank=True,
            ...
            options={'verbose_name': 'Reference Data Set', 'db_table': 'app_referencedataset',},
        ),
        migrations.CreateModel(
            name='SourceTable',
            fields=[
                ...
                (
                    'name',
                    models.CharField(help_text='Used as the displayed text in the download link', max_length=1024,),
                ),
                (
                    'schema',
                    models.CharField(
                        default='public',
                        max_length=1024,
                        validators=[django.core.validators.RegexValidator(regex='^[a-zA-Z][a-zA-Z0-9_\\.]*$')],
                    ),
                ),
                (
                    'table',
                ...
                (
                    'database',
                    models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='core.Database',),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False,),),
                ('link_type', models.IntegerField(choices=[(1, 'External Link'), (2, 'Local Link')], default=1),),
                (
                    'name',
                    models.CharField(help_text='Used as the displayed text in the download link', max_length=128,),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'is_identifier',
                    models.BooleanField(default=False, help_text='This field is the unique identifier for the record',),
                ),
        ...
        migrations.CreateModel(
            ...
            options={'db_table': 'app_datasetuserpermission', 'unique_together': {('user', 'dataset')},},
        ),
    ]
