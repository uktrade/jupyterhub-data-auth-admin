...
from dataworkspace.apps.core.templatetags.core_filters import get_choice_field_data_for_gtm
...
class _ExampleForm(Form):
    ...
    multi = MultipleChoiceField(
        choices=((1, 'one'), (2, 'two'), (3, 'three'), (4, 'four'), (5, 'five')), required=False,
    )
...
@pytest.mark.parametrize(
    'selections, expected_string', (([], ''), ([1, 3], 'one;three'), ([1, 3, 5], 'five;one;three')),
)
