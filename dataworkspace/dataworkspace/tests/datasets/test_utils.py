...
from dataworkspace.apps.datasets.utils import dataset_type_to_manage_unpublished_permission_codename
...
def test_dataset_type_to_manage_unpublished_permission_codename():
    ...
    assert (
        dataset_type_to_manage_unpublished_permission_codename(DataSet.TYPE_MASTER_DATASET)
