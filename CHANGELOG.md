...
- Deprecated user access controls from visualisation templates. These can be purged from code later by squashing migrartions when everyone's migrations are up-to-date.
